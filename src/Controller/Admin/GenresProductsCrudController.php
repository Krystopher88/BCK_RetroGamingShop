...
class GenresProductsCrudController extends AbstractCrudController
{
    ...
    public function configureActions(Actions $actions): Actions
    {
        return $actions
            ...
            ->update(Crud::PAGE_NEW, Action::SAVE_AND_RETURN, function (Action $action) {
                return $action->setLabel('Ajouter un autre genre');
            })
            ->update(Crud::PAGE_NEW, Action::SAVE_AND_ADD_ANOTHER, function (Action $action) {
                return $action->setLabel('Ajouter et ajouter un autre genre');
            })
    ...
    {
        yield TextField::new('genre', 'Genre');
        yield SlugField::new('slug', 'Slug')->setTargetFieldName('genre');
    }
